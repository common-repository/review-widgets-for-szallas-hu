...
Description: Szállás.hu review widgets. Show your szallas.hu reviews on your WordPress website to build trust and increase your SEO.
...
$pluginManagerInstance = $trustindex_pm_szallashu;
...
<p>
<a href="<?php echo admin_url("admin.php?page=review-widgets-for-szallas-hu/settings.php&wc_notification=open"); ?>" target="_blank" class="trustindex-rateus" style="text-decoration: none">
<button class="button button-primary"><?php echo __('Download plugin', 'trustindex-plugin'); ?></button>
</a>
<a href="<?php echo admin_url("admin.php?page=review-widgets-for-szallas-hu/settings.php&wc_notification=hide"); ?>" class="trustindex-rateus" style="text-decoration: none">
