...
$pluginManager = 'TrustindexPlugin_szallashu';
$pluginManagerInstance = $trustindex_pm_szallashu;
$pluginNameForEmails = 'Szállás.hu';
$newBadgeTabs = [];
...
$assetCheckCssId = 'trustindex_settings_style_szallashu';
